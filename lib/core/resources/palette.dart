...
class Palette {
  ...
  static const Color secondary = Color(0XFF672CBC);

  static const Color darkPurple = Color(0XFF3B1E77);
  static const Color blackPurple = Color(0XFF240F4F);
  static const Color darkTheme = Color.fromRGBO(9, 25, 69, 1.0);
  static const Color grey = Color(0XFF8789A3);
  static const Color grey92 = Color(0XFFebebeb);
  static const Color greyLight = Color(0XFFabafd7);
  static const Color mikadoYellow = Color(0XFFF9B091);
  static const Color linearPurple1 = Color.fromRGBO(223, 152, 250, 1.0);
  static const Color linearPurple2 = Color.fromRGBO(144, 85, 255, 1.0);
  static const Color background = Color(0xffeff1f5);
  static const Color backgroundDark = Color(0XFF152451);
